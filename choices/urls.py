...
urlpatterns = [
    path(
        ...
        name="marital_status_choices",
    ),
    path("choices/closed_choices", closed_choices, name="closed_choices"),
    path(
        "choices/home_status_choices", home_status_choices, name="home_status_choices"
    ),
    path(
        "choices/preferred_sex_choices",
        preferred_sex_choices,
        name="preferred_sex_choices",
    ),
]
